...
#   }
#   tag {
#     scope = "ncp/shared_resource"
#     tag   = "true"
#   }
# }

# resource "nsxt_static_route" "t0_default_egress" {
#   description       = "Default route for egress traffic from NSX-T routers."
#   logical_router_id = "${nsxt_logical_tier0_router.t0_router.id}"
#   network           = "0.0.0.0/0"

#   next_hop {
#     ip_address              = "${var.nsxt_gateway_ip}"
